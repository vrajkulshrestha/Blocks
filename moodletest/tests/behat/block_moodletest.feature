...
Feature: Block moodle test
  In order to overview moodle test modules in a course
  As a manager
  I can add moodletest block in a course or on the frontpage

  Scenario: Add moodletest block on the frontpage
  ...
  Scenario: Add moodletest block in a course
